...
var CameraMoveScript = /** @class */ (function (_super) {
    ...
    CameraMoveScript.prototype.updateCamera = function (elapsedTime) {
        ...
        // console.debug("x -> " + this.camera.transform.localPosition.x);
        // console.debug("y -> " + this.camera.transform.localPosition.y);
        // console.debug("z -> " + this.camera.transform.localPosition.z);
        // console.debug("=============== rotation ===============");
        // console.debug("x -> " + this.camera.transform.localRotationEuler.x);
        // console.debug("y -> " + this.camera.transform.localRotationEuler.y);
        // console.debug("z -> " + this.camera.transform.localRotationEuler.z);
    };
